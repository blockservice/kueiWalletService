...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for EwsSubscribe requests
}
...
// EwsSubscribe registers a subscripion under the "eth" namespace.
func (c *Client) EwsSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "ews", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. EwsSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through EwsSubscribe.
